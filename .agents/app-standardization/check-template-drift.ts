 ...
 * the canonical tideye and reports files that have drifted.
 *
 * Usage:
 ...
 *
 * Requirements:
 *   - Both the app and ~/new-code/tideye must exist
 */
...
const TEMPLATE_DIR = join(process.env.HOME || '~', 'new-code', 'tideye')
