...
const HUB_KEYS: Record<string, string> = {
  CLOUDFLARE_API_TOKEN: 'tideye',
  CLOUDFLARE_ACCOUNT_ID: 'tideye',
...
function main() {
  ...
  console.log('         hub=all hub keys are cross-refs to tideye / narduk-analytics')
  console.log()
}
