...
-- Password hash for 'testpass123' generated via the layer's hashUserPassword() (PBKDF2-SHA256, 100k iterations)
...
INSERT OR IGNORE INTO notifications (id, user_id, kind, title, body, icon, action_url, is_read, created_at)
VALUES
